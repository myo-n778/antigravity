...
import { BenzeneOnlyQuiz } from './modes/BenzeneOnlyQuiz';
...
export const Quiz: React.FC<QuizProps> = ({ compounds, mode, category, onBack }) => {
  switch (mode) {
    ...
    case 'compound-type':
      return <CompoundTypeQuiz compounds={compounds} category={category} onBack={onBack} />;
    case 'benzene-only':
      return <BenzeneOnlyQuiz compounds={compounds} category={category} onBack={onBack} />;
    case 'substitution':
